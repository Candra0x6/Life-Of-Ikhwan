...
public class Battlefield extends ScrollWorld {
    ...
    public Battlefield() {
        ...
        setPaintOrder(MissionDisplay.class, TextInfo.class, MoneyDisplay.class, BorderForest.class, Player.class,
                PrayerMat.class, Budi.class, TreeTop.class, ZakatBox.class, Zero.class);
        int numTrees = 2;
